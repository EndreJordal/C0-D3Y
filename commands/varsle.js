...
const filter = (interaction) => interaction.customId === `varsel-${interaction.user.id}`
interaction
...
.then(async (modalInteraction) => {
 ...
 modalInteraction.reply({
   content: "Ditt varsel har blitt mottatt. Du vil bli kontaktet av en veileder/ansatt i løpet av kort tid.",
   ephemeral: true,
 })
})
};
